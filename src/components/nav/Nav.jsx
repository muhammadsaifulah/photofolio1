        ...
        <div ref={menu} className="menu">
          <IoMdClose onClick={closeMenu} size={30} className='cross'/>
            <ul className='text-uppercase d-flex list-unstyled gap-3 p-0 m-0 '>
                <li>Home</li>
                <li>About</li>
                <li className='position-relative gal'>Gallery
                <FaChevronDown/>
                 <div className="sub-menu position-absolute py-2">
                    <ul className='list-unstyled text-capitalize d-flex flex-column gap-2'>
                        ...
                        <li>sports</li>
                        <li>travel</li>
                        <li className='d-flex position-relative justify-content-between align-items-center sub-sub '>sub menu <MdChevronRight/>
